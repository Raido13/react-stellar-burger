...
export const Field : FC<{name: string, initialValue: string, placeholder: string, fillForm: (e: ChangeEvent<HTMLInputElement>) => void}> = ({name, initialValue, placeholder, fillForm}) => {
